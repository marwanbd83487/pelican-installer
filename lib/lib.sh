...
# download URLs
export PANEL_DL_URL="https://github.com/pelican-dev/panel/releases/download/v1.0.0-beta1/panel.tar.gz"
export WINGS_DL_BASE_URL="https://github.com/pelican-dev/wings/releases/download/v1.0.0-beta1/wings_linux_"
export MARIADB_URL="https://downloads.mariadb.com/MariaDB/mariadb_repo_setup"
export GITHUB_BASE_URL=${GITHUB_BASE_URL:-"https://raw.githubusercontent.com/marwanbd83487/pelican-installer"}
